...
python3 "${script_filepath2}"/CO2_sqlUpload.py  -c /dev/ttyUSB0  -f $data_filepath -n 3 -cn Jun28Experiment -e June_2024 &
python3 "${script_filepath2}"/O2_sqlUpload.py   -c /dev/ttyUSB1  -f $data_filepath -n 3 -cn Jun28Experiment -e June_2024 &
