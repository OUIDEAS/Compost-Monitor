...
while 1:
    while RBSerial.in_waiting:
        ...
        if RB_inbyte == b'\n':
            ...
            print('RedBoard in container {} good at time {}. \nTVOC Reading: {}\tHumidity: {}\tPressure: {}\tTemp: {}\n' .format(args.containernumber, time.strftime("%H:%M:%S"), RB_DataList[1], RB_DataList[2], RB_DataList[3], RB_DataList[4]))
